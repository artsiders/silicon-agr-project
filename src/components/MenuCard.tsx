...
import { addItemToCart } from "../feature/restoCart.slice";
...
export default function MenuCard(props: Props) {
    ...
    const handleAddToCart = () => {
        dispatch(addItemToCart({ ...plat, quantity: 1 }));
    };
    return (
        <div
            className="w-[90vw] z-10 sm:w-60 block shadow-card dark:shadow-none rounded-2xl bg-white dark:bg-tertiary">
            ...
            <div className="p-3">
                ...
                <p className="font-bold text-lg">{plat.price}</p>
